...
def text_cat(train_input = 0, test_input = 0):
	...
	output_file_name = input('Enter a name for the category prediction output file: ')
...
train_input = input('Please specify the name of the file containing the list of labeled training documents: ')
test_input  = input('Please specify the name of the file containing the list of unlabeled test documents: ')
